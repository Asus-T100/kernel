...
menuconfig get_kernel_from_source: $(MINIGZIP)
	+TARGET_TOOLS_PREFIX="$(ANDROID_BUILD_TOP)/$(TARGET_TOOLS_PREFIX)" DIFFCONFIGS="$(DIFFCONFIGS)" vendor/intel/support/kernel-build.sh $(KERNEL_BUILD_FLAGS) -c $(CUSTOM_BOARD) -o $@
