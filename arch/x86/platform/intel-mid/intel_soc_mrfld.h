...
#define IGNORE_SSS0 (				\
	...
	SSMSK(D0I3_MASK, PMU_USB3_LSS_09)	| \
	SSMSK(D0I3_MASK, PMU_AUDIO_LSS_10)	| \
...
#define IGNORE_SSS1 (				\
	...
	SSMSK(D0I3_MASK, PMU_I2C2_LSS_21-16)	| \
	SSMSK(D0I3_MASK, PMU_I2C3_LSS_22-16)	| \
	SSMSK(D0I3_MASK, PMU_I2C4_LSS_23-16)	| \
	SSMSK(D0I3_MASK, PMU_I2C5_LSS_24-16)	| \
	SSMSK(D0I3_MASK, PMU_GP_DMA_LSS_25-16)	| \
	SSMSK(D0I3_MASK, PMU_I2C6_LSS_26-16)	| \
	SSMSK(D0I3_MASK, PMU_I2C7_LSS_27-16)	| \
	SSMSK(D0I3_MASK, PMU_USB_OTG_LSS_28-16)	| \
	SSMSK(D0I3_MASK, PMU_UART0_LSS_31-16))
