...
static struct pinstruct_t ctp_pin_table[CTP_PIN_NUM] = {
	...
	[ulpi1lpc_gpe_b]		 = { true,	0x02,	0x30,	0,	0x10,	0,	0x51,    0xFF },
	[ulpi1lpc_lpc_ad0]		 = { true,	0x02,	0x30,	6,	0x10,	4,	0x51,    0xFF },
	[ulpi1lpc_lpc_ad1]		 = { true,	0x02,	0x30,	12,	0x10,	8,	0x51,    0xFF },
	[ulpi1lpc_lpc_ad2]		 = { true,	0x02,	0x30,	18,	0x10,	12,	0x51,    0xFF },
	[ulpi1lpc_lpc_ad3]		 = { true,	0x02,	0x30,	24,	0x10,	16,	0x51,    0xFF },
	[ulpi1lpc_lpc_clkout]		 = { true,	0x02,	0x31,	0,	0x10,	20,	0x51,    0xFF },
	[ulpi1lpc_lpc_clkrun]		 = { true,	0x02,	0x31,	6,	0x10,	24,	0x51,    0xFF },
	[ulpi1lpc_lpc_frame_b]		 = { true,	0x02,	0x31,	12,	0x10,	28,	0x51,    0xFF },
	[ulpi1lpc_lpc_reset_b]		 = { true,	0x02,	0x31,	18,	0x11,	0,	0x51,    0xFF },
	[ulpi1lpc_lpc_serirq]		 = { true,	0x02,	0x31,	24,	0x11,	4,	0x51,    0xFF },
	[ulpi1lpc_lpc_smi_b]		 = { true,	0x02,	0x32,	0,	0x11,	8,	0x51,    0xFF },
	[ulpi1lpc_usb_ulpi_1_clk]	 = { true,	0x02,	0x32,	6,	0x11,	12,	0x51,    0xFF },
	[ulpi1lpc_usb_ulpi_1_data0]	 = { true,	0x02,	0x32,	12,	0x11,	16,	0x51,    0xFF },
	[ulpi1lpc_usb_ulpi_1_data1]	 = { true,	0x02,	0x32,	18,	0x11,	20,	0x51,    0xFF },
	[ulpi1lpc_usb_ulpi_1_data2]	 = { true,	0x02,	0x32,	24,	0x11,	24,	0x51,    0xFF },
	[ulpi1lpc_usb_ulpi_1_data3]	 = { true,	0x02,	0x33,	0,	0x11,	28,	0x51,    0xFF },
	[ulpi1lpc_usb_ulpi_1_data4]	 = { true,	0x02,	0x33,	6,	0x12,	0,	0x51,    0xFF },
	[ulpi1lpc_usb_ulpi_1_data5]	 = { true,	0x02,	0x33,	12,	0x12,	4,	0x51,    0xFF },
	[ulpi1lpc_usb_ulpi_1_data6]	 = { true,	0x02,	0x33,	18,	0x12,	8,	0x51,    0xFF },
	[ulpi1lpc_usb_ulpi_1_data7]	 = { true,	0x02,	0x33,	24,	0x12,	12,	0x51,    0xFF },
	[ulpi1lpc_usb_ulpi_1_dir]	 = { true,	0x02,	0x34,	0,	0x12,	16,	0x51,    0xFF },
	[ulpi1lpc_usb_ulpi_1_nxt]	 = { true,	0x02,	0x34,	6,	0x12,	20,	0x51,    0xFF },
	[ulpi1lpc_usb_ulpi_1_refclk]	 = { true,	0x02,	0x34,	12,	0x12,	24,	0x51,    0xFF },
	[ulpi1lpc_usb_ulpi_1_stp]	 = { true,	0x02,	0x34,	18,	0x12,	28,	0x51,    0xFF },
	...
	[i2c_0_scl]			 = { true,	0x15,	0x30,	0,	0x10,	0,	0x51,    6 },
	[i2c_0_sda]			 = { true,	0x15,	0x30,	6,	0x10,	4,	0x51,    7 },
	[i2c_1_scl]			 = { true,	0x15,	0x30,	12,	0x10,	8,	0x51,    8 },
	[i2c_1_sda]			 = { true,	0x15,	0x30,	18,	0x10,	12,	0x51,    9 },
	[i2c_2_scl]			 = { true,	0x15,	0x30,	24,	0x10,	16,	0x51,    10 },
	[i2c_2_sda]			 = { true,	0x15,	0x31,	0,	0x10,	20,	0x51,    11 },
	[spi_1_clk]			 = { true,	0x15,	0x31,	6,	0x10,	24,	0x51,    12 },
	[spi_1_sdi]			 = { true,	0x15,	0x31,	12,	0x10,	28,	0x51,    13 },
	[spi_1_sdo]			 = { true,	0x15,	0x31,	18,	0x11,	0,	0x51,    14 },
	[spi_1_ss0]			 = { true,	0x15,	0x31,	24,	0x11,	4,	0x51,    15 },
	[spi_1_ss1]			 = { true,	0x15,	0x32,	0,	0x11,	8,	0x51,    16 },
	[spi_1_ss2]			 = { true,	0x15,	0x32,	6,	0x11,	12,	0x51,    17 },
	[spi_1_ss3]			 = { true,	0x15,	0x32,	12,	0x11,	16,	0x51,    18 },
	[spi_1_ss4]			 = { true,	0x15,	0x32,	18,	0x11,	20,	0x51,    19 }
};
