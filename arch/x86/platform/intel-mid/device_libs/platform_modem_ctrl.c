...
static int mdm_ctrl_is_supported_ctp(void)
{
	...
	return INTEL_MID_BOARD(1, PHONE, CLVTP) &&
		...
		!SPID_HARDWARE_ID(CLVTP, PHONE, RHB, CCVV2VB) &&
		!SPID_HARDWARE_ID(CLVTP, PHONE, RHB, VBDV1) &&
		!SPID_HARDWARE_ID(CLVTP, PHONE, RHB, VV3AVB) &&
		!SPID_HARDWARE_ID(CLVTP, PHONE, RHB, VV3BVB) &&
		!SPID_HARDWARE_ID(CLVTP, PHONE, RHB, VV3CVB) &&
		!SPID_HARDWARE_ID(CLVTP, PHONE, RHB, VBDV1A) &&
		!SPID_HARDWARE_ID(CLVTP, PHONE, RHB, VBDV1B);
}
