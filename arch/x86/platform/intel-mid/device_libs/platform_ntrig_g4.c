/*
 * platform_ntrig_g4.c: ntrig touchscreen platform data initilization file
 *
 * (C) Copyright 2012 aava mobile
 * Author:
 *
...
#include "platform_ntrig_g4.h"


void __init *ntrig_g4_platform_data(void *info)
{
