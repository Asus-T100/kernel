...
#define BYT_EC_SCI_EXPCARDPRSNT		0x43	/* Express card insertion/removal SCI */
...
#define BYT_EC_SCI_VB			0x53	/* SCI from virtual battery switch */
...
#define BYT_EC_SCI_GYSRVL		0xB0	/* SCI for Geyserville break event */
#define BYT_EC_SCI_THERMAL		0xF0	/* Thermal transition SCI */
#define BYT_EC_SCI_THERMTRIP		0xF1	/* Thermal trip point transition SCI */
