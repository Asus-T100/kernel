...
enum {
	...
	INTEL_MFLDT_FM_PRO  = 0x0001,
	INTEL_MFLDT_FM_ENG  = 0x8001,
	INTEL_MFLDT_FVA_PRO = 0x0002,
	INTEL_MFLDT_FVA_ENG = 0x8002,
	INTEL_MFLDT_SLP_PRO = 0x0003,
	INTEL_MFLDT_SLP_ENG = 0x8003,
	INTEL_MFLDT_YKB_PRO = 0x0004,
	INTEL_MFLDT_YKB_ENG = 0x8004,
...
enum {
	INTEL_MRFLP_SB_PRO = 0x0000,
	INTEL_MRFLP_SB_ENG = 0x8000,
...
enum {
	...
	MFLDP_LEX_PR2M, /* BND/PNW 1GHz CSEK D1 */
	MFLDP_LEX_DV1,  /* BND/PNW 1.2GHz CSEK D1 */
	MFLDP_LEX_RSVD,
...
/* Hardware_ID table for Product_Line_ID == INTEL_MFLDT_FM */
enum {
	MFLDT_FM_EV20, /* CRAK D0 */
	MFLDT_FM_DV10, /* CRAK D1 */
	MFLDT_FM_RSVD,
	MFLDT_FM_UNKNOWN = 0xFFFF
};

/* Hardware_ID table for Product_Line_ID == INTEL_MFLDT_FVA */
enum {
	MFLDT_FVA_EV10P, /* CRAK Dx */
	MFLDT_FVA_EV10,  /* CRAK Dx */
	MFLDT_FVA_EV20,  /* CRAK Dx */
	MFLDT_FVA_DV10,  /* CRAK Dx */
	MFLDT_FVA_RSVD,
	MFLDT_FVA_UNKNOWN = 0xFFFF
};

/* Hardware_ID table for Product_Line_ID == INTEL_MFLDT_SLP */
enum {
	MFLDT_SLP_EV05, /* CRAK Dx */
	MFLDT_SLP_EV10, /* CRAK Dx */
	MFLDT_SLP_EV20, /* CRAK Dx */
	MFLDT_SLP_DV10, /* CRAK Dx */
	MFLDT_SLP_RSVD,
	MFLDT_SLP_UNKNOWN = 0xFFFF
};

/* Hardware_ID table for Product_Line_ID == INTEL_MFLDT_YKB */
enum {
	MFLDT_YKB_DV10, /* CRAK Dx */
	MFLDT_YKB_RSVD,
	MFLDT_YKB_UNKNOWN = 0xFFFF
};
...
enum {
	...
	CLVTPP_RHB_PR10PM, /* CLV+ A0 */
	CLVTPP_RHB_CCVV1P, /* Clover City Pre-VV1 Fab B CLV+ A0 */
	CLVTPP_RHB_PR10P,  /* RHB Pre-PR1.0 CLV A0 C- CLASS */
	CLVTPP_RHB_PR10M,  /* RHB Macro PR1.0 CLV+ A0 */
	CLVTPP_RHB_PR10,   /* RHB PR1.0 CLV+ A0 C-CLASS */
	CLVTPP_RHB_PR15M,  /* RHB Macro PR1.5 CLV+ A0 */
	CLVTPP_RHB_PR15,   /* RHB PR1.5 CLV+ A0 C-CLASS */
	CLVTPP_RHB_PR20M,  /* RHB Macro PR2.0 CLV+ B0 */
	CLVTPP_RHB_PR20,   /* RHB PR2.0 CLV+ B0 C-CLASS */
	CLVTPP_RHB_PR30M,  /* RHB Macro PR3.0 CLV+ B0 */
	CLVTPP_RHB_CCVV3,  /* Clover City VV3 FAB D CLV+ A0 */
	CLVTPP_RHB_PR30,   /* RHB PR3.0 CLV+ B0 C-CLASS */
	CLVTPP_RHB_DV1,    /* RHB Dv1 */
	CLVTPP_RHB_PR20A,  /* CLV+ B0 C-Class-touch panel sensor GFF */
	CLVTPP_RHB_CCVV2VB, /* Clover City VV2-Victoria Bay FAB B CLV B0 */
	CLVTPP_RHB_PR19M,  /* Macro PR1.9 CLV+ B0 */
	CLVTPP_RHB_PR199M, /* Macro PR1.99 CLV+ B0 */
	CLVTPP_RHB_VBDV1,  /* VictoriaBay DV1 CLV+ B0 Renasas Modem BRCM CWS */
	CLVTPP_RHB_PR20B,  /* CLV+ B0 C-Class-touch panel sensor GFF-LPDDR2 */
	CLVTPP_RHB_RSVD,
...
enum {
	...
	CLVTT_TBD_VV2SS, /* Clover City VV2-Samtab-FAB B CLV+ B0 */
	CLVTT_TBD_RSVD,
	CLVTT_TBD_UNKNOWN = 0xFFFF
};

/* Hardware_ID table for Product_Line_ID == INTEL_MRFLP_SB */
enum {
	MRFLP_SB_VVA,  /* SilverRidge VV FAB A */
	MRFLP_SB_VVB,  /* SilverRidge VV FAB B */
	MRFLP_SB_VVC,  /* SilverRidge VV FAB C */
	MRFLP_SB_VVD,  /* SilverRidge VV FAB D */
	MRFLP_SB_SVA,  /* SilverRidge SV FAB A */
	MRFLP_SB_SVB,  /* SilverRidge SV FAB B */
	MRFLP_SB_SVC,  /* SilverRidge SV FAB C */
	MRFLP_SB_SVD,  /* SilverRidge SV FAB D */
	MRFLP_SB_PR0M, /* Salt Bay PR0-Macro (A0) */
	MRFLP_SB_PR0,  /* Salt Bay PR0-FF (A0) */
	MRFLP_SB_PR1M, /* Salt Bay PR1-Macro (A0) */
	MRFLP_SB_PR1,  /* Salt Bay PR1-FF (A0) */
	MRFLP_SB_PR2M, /* Salt Bay PR2-Macro (B0) */
	MRFLP_SB_PR2,  /* Salt Bay PR2-FF (B0) */
	MRFLP_SB_PR3M, /* Salt Bay PR3-Macro (B0) */
	MRFLP_SB_PR3,  /* Salt Bay PR3-FF (B0) */
	MRFLP_TBD_RSVD,
