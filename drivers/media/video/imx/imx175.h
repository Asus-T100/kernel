...
/************************** settings for imx *************************/
static struct imx_reg const imx_STILL_8M_20fps[] = {
	...
	{IMX_8BIT, 0x0341, 0x50},  /*	frame_length_lines[7:0]	*/
	{IMX_8BIT, 0x0342, 0x12},  /*	line_length_pck[15:8]	*/
	{IMX_8BIT, 0x0343, 0x20},  /*	line_length_pck[7:0]	*/
...
static struct imx_reg const imx_STILL_3M_20fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	{IMX_8BIT, 0x0100, 0x00},  /*	mode_select	*/
	/* shutter */
	{IMX_8BIT, 0x0202, 0x0A},  /* coarse _integration_time[15:8] */
	...
	{IMX_8BIT, 0x0343, 0xD0},  /*	line_length_pck[7:0]	*/
	{IMX_8BIT, 0x0344, 0x02},  /*	x_addr_start[15:8]	*/
	{IMX_8BIT, 0x0345, 0x60},  /*	x_addr_start[7:0]	*/
	{IMX_8BIT, 0x0346, 0x01},  /*	y_addr_start[15:8]	*/
	{IMX_8BIT, 0x0347, 0xC8},  /*	y_addr_start[7:0]	*/
	{IMX_8BIT, 0x0348, 0x0A},  /*	x_addr_end[15:8]	*/
	{IMX_8BIT, 0x0349, 0x70},  /*	x_addr_end[7:0]	*/
	{IMX_8BIT, 0x034A, 0x07},  /*	y_addr_end[15:8]	*/
	{IMX_8BIT, 0x034B, 0xD8},  /*	y_addr_end[7:0]	*/
...
static struct imx_reg const imx_STILL_5M_20fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	{IMX_8BIT, 0x0100, 0x00},  /*	mode_select	*/
	/* shutter */
	{IMX_8BIT, 0x0202, 0x0A},  /* coarse _integration_time[15:8] */
	...
	{IMX_8BIT, 0x0345, 0x60},  /*	x_addr_start[7:0]	*/
	{IMX_8BIT, 0x0346, 0x01},  /*	y_addr_start[15:8]	*/
	{IMX_8BIT, 0x0347, 0x08},  /*	y_addr_start[7:0]	*/
	{IMX_8BIT, 0x0348, 0x0B},  /*	x_addr_end[15:8]	*/
	{IMX_8BIT, 0x0349, 0x70},  /*	x_addr_end[7:0]	*/
	{IMX_8BIT, 0x034A, 0x08},  /*	y_addr_end[15:8]	*/
	{IMX_8BIT, 0x034B, 0x98},  /*	y_addr_end[7:0]	*/
...
static struct imx_reg const imx_STILL_6M_20fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	{IMX_8BIT, 0x0100, 0x00},  /*	mode_select	*/
	/* shutter */
	{IMX_8BIT, 0x0202, 0x0A},  /* coarse _integration_time[15:8] */
...
static struct imx_reg const imx_STILL_2M_25fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	{IMX_8BIT, 0x0100, 0x00},  /*	mode_select	*/
	/* shutter */
	{IMX_8BIT, 0x0202, 0x0A},  /* coarse _integration_time[15:8] */
	...
	{IMX_8BIT, 0x0342, 0x0E},  /*	line_length_pck[15:8]	*/
	{IMX_8BIT, 0x0343, 0xC8},  /*	line_length_pck[7:0]	*/
	{IMX_8BIT, 0x0344, 0x00},  /*	x_addr_start[15:8]	*/
	{IMX_8BIT, 0x0345, 0x00},  /*	x_addr_start[7:0]	*/
	{IMX_8BIT, 0x0346, 0x00},  /*	y_addr_start[15:8]	*/
	{IMX_8BIT, 0x0347, 0x00},  /*	y_addr_start[7:0]	*/
...
struct imx_resolution imx175_res_preview[] = {
	...
	{
		.desc = "STILL_2M_25fps",
		.regs = imx_STILL_2M_25fps,
		.width = 1640,
		.height = 1232,
		.fps = 25,
		.pixels_per_line = 0x0EC8, /* consistent with regs arrays */
	...
	{
		.desc = "STILL_3M_20fps",
		.regs = imx_STILL_3M_20fps,
		.width = 2064,
		.height = 1552,
		.fps = 20,
		.pixels_per_line = 0x11D0, /* consistent with regs arrays */
	...
	{
		.desc = "STILL_8M_20fps",
		.regs = imx_STILL_8M_20fps,
		.width = 3280,
		.height = 2464,
		.fps = 20,
		.pixels_per_line = 0x1220, /* consistent with regs arrays */
		.lines_per_frame = 0x0B50, /* consistent with regs arrays */
		.bin_factor_x = 0,
		.bin_factor_y = 0,
		.used = 0,
	},
...
struct imx_resolution imx175_res_video[] = {
	...
	},
	{
		...
		.height =	1308,
		.fps = 30,
		.pixels_per_line = 0x1500, /* consistent with regs arrays */
		.lines_per_frame = 0x0650, /* consistent with regs arrays */
		.bin_factor_x = 0,
		.bin_factor_y = 0,
		.used = 0,
	},
