...
static struct imx_reg const imx135_1080p_dvs_17fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	/* Clock setting */
	{IMX_8BIT, 0x011E, 0x13},
	{IMX_8BIT, 0x011F, 0x33},
...
static struct imx_reg const imx135_720p_dvs_15fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	/* Clock setting */
	{IMX_8BIT, 0x011E, 0x13},
	{IMX_8BIT, 0x011F, 0x33},
...
struct imx_resolution imx135_res_video[] = {
	...
	{
		.desc = "imx135_720p_dvs_15fps",
		.regs = imx135_720p_dvs_15fps,
		.width = 1568	,
		.height = 880,
		.fps = 15,
	...
	{
		.desc = "imx135_1080p_dvs_17fps",
		.regs = imx135_1080p_dvs_17fps,
		.width = 2336	,
		.height = 1320,
		.fps = 17,
		.pixels_per_line = 0x11DC, /* consistent with regs arrays */
