...
static struct imx_reg const imx135vb_SwReset[] = {
...
static struct imx_reg const imx135vb_13M_25fps[] = {
...
static struct imx_reg const imx135vb_13M_3fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	/* Clock Setting */
...
static struct imx_reg const imx135vb_13M_24fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	/* Clock Setting */
...
static struct imx_reg const imx135vb_8M_3fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	/* Clock Setting */
	{ IMX_8BIT, 0x011E, 0x13},
	{ IMX_8BIT, 0x011F, 0x33},
...
static struct imx_reg const imx135vb_5M_26fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	/* Mode setting */
	{IMX_8BIT, 0x0108, 0x03},
	{IMX_8BIT, 0x0112, 0x0A},
...
static struct imx_reg const imx135vb_1080p_dvs_30fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	/* Mode setting */
	{IMX_8BIT, 0x0108, 0x03},
	{IMX_8BIT, 0x0112, 0x0A},
...
static struct imx_reg const imx135vb_wide_preview_30fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	/* Mode setting */
	{IMX_8BIT, 0x0108, 0x03},
	{IMX_8BIT, 0x0112, 0x0A},
...
static struct imx_reg const imx135vb_D1_dvs_30fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	/* Mode setting */
	{IMX_8BIT, 0x0108, 0x03},
	{IMX_8BIT, 0x0112, 0x0A},
...
static struct imx_reg const imx135vb_preview_30fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	/* Mode setting */
	{IMX_8BIT, 0x0108, 0x03},
	{IMX_8BIT, 0x0112, 0x0A},
...
static struct imx_reg const imx135vb_VGA_dvs_30fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	/* Clock setting */
	{IMX_8BIT, 0x011E, 0x13},
	{IMX_8BIT, 0x011F, 0x33},
...
static struct imx_reg const imx135vb_CIF_30fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	/* Mode setting */
	{IMX_8BIT, 0x0108, 0x03},
	{IMX_8BIT, 0x0112, 0x0A},
...
static struct imx_reg const imx135vb_QVGA_dvs_30fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	/* Mode setting */
	{IMX_8BIT, 0x0108, 0x03},
	{IMX_8BIT, 0x0112, 0x0A},
...
static struct imx_reg const imx135vb_QCIF_dvs_30fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	/* Mode setting */
	{IMX_8BIT, 0x0108, 0x03},
	{IMX_8BIT, 0x0112, 0x0A},
...
static struct imx_reg const imx135vb_6M_30fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	/* Mode setting */
	{IMX_8BIT, 0x0108, 0x03},
	{IMX_8BIT, 0x0112, 0x0A},
...
static struct imx_reg const imx135vb_3M_30fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	/* Clock setting */
	{IMX_8BIT, 0x011E, 0x13},
	{IMX_8BIT, 0x011F, 0x33},
...
static struct imx_reg const imx135vb_1080p_30fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	/* Clock setting */
	{IMX_8BIT, 0x011E, 0x13},
	{IMX_8BIT, 0x011F, 0x33},
...
static struct imx_reg const imx135vb_2M_30fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	{IMX_8BIT, 0x011E, 0x13},
	{IMX_8BIT, 0x011F, 0x33},
	{IMX_8BIT, 0x0301, 0x05},
...
static struct imx_reg const imx135vb_1600x1200_30fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	{ IMX_8BIT, 0x011E, 0x13},
	{ IMX_8BIT, 0x011F, 0x33},
	{ IMX_8BIT, 0x0301, 0x05},
...
static struct imx_reg const imx135vb_720p_30fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	/* Clock setting */
	{IMX_8BIT, 0x011E, 0x13},
	{IMX_8BIT, 0x011F, 0x33},
...
static struct imx_reg const imx135vb_1M_4_3_30fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	{IMX_8BIT, 0x011E, 0x13},
	{IMX_8BIT, 0x011F, 0x33},
	{IMX_8BIT, 0x0301, 0x05},
...
static struct imx_reg const imx135vb_D1_30fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	/* Mode setting */
	{IMX_8BIT, 0x0108, 0x03},
	{IMX_8BIT, 0x0112, 0x0A},
...
static struct imx_reg const imx135vb_VGA_30fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	{IMX_8BIT, 0x011E, 0x13},
	{IMX_8BIT, 0x011F, 0x33},
	{IMX_8BIT, 0x0301, 0x05},
...
static struct imx_reg const imx135vb_CIF_dvs_30fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	/* Mode setting */
	{IMX_8BIT, 0x0108, 0x03},
	{IMX_8BIT, 0x0112, 0x0A},
...
static struct imx_reg const imx135vb_QVGA_30fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	{IMX_8BIT, 0x011E, 0x13},
	{IMX_8BIT, 0x011F, 0x33},
	{IMX_8BIT, 0x0301, 0x05},
...
static struct imx_reg const imx135vb_QCIF_30fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	/* Mode setting */
	{IMX_8BIT, 0x0108, 0x03},
	{IMX_8BIT, 0x0112, 0x0A},
...
static struct imx_reg const imx135vb_init_settings_bak[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	/* Basic Config */
...
static const struct imx_reg imx135vb_VGA_STILL_74fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	/* Mode setting */
	{IMX_8BIT, 0x0108, 0x03 },
	{IMX_8BIT, 0x0112, 0x0A },
...
static const struct imx_reg imx135vb_1080P_STILL_48fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	/* Mode setting */
	{IMX_8BIT, 0x0108, 0x03 },
	{IMX_8BIT, 0x0112, 0x0A },
...
static const struct imx_reg imx135vb_1M_STILL_37fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	/* Mode setting */
	{IMX_8BIT, 0x0108, 0x03 },
	{IMX_8BIT, 0x0112, 0x0A },
...
static const struct imx_reg imx135vb_2M_STILL_37fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	/* Mode setting */
	{IMX_8BIT, 0x0108, 0x03 },
	{IMX_8BIT, 0x0112, 0x0A },
...
static const struct imx_reg imx135vb_3M_STILL_37fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	/* Mode setting */
	{IMX_8BIT, 0x0108, 0x03 },
	{IMX_8BIT, 0x0112, 0x0A },
...
static const struct imx_reg imx135vb_5M_STILL_19fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	{ IMX_8BIT, 0x011E, 0x13},
	{ IMX_8BIT, 0x011F, 0x33},
	{ IMX_8BIT, 0x0301, 0x05},
...
static const struct imx_reg imx135vb_6M_STILL_20fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	{ IMX_8BIT, 0x011E, 0x13},
	{ IMX_8BIT, 0x011F, 0x33},
	{ IMX_8BIT, 0x0301, 0x05},
...
static const struct imx_reg imx135vb_8M_STILL_15fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	{ IMX_8BIT, 0x011E, 0x13},
	{ IMX_8BIT, 0x011F, 0x33},
	{ IMX_8BIT, 0x0301, 0x05},
...
static const struct imx_reg imx135vb_13M_STILL_7fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	/* Mode setting */
	{IMX_8BIT, 0x0108, 0x03 },
	{IMX_8BIT, 0x0112, 0x0A },
...
static struct imx_reg const imx135vb_PREVIEW_848x616_30fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	{ IMX_8BIT, 0x011E, 0x13},
	{ IMX_8BIT, 0x011F, 0x33},
	{ IMX_8BIT, 0x0301, 0x05},
...
static struct imx_reg const imx135vb_1M_16_9_30fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	{ IMX_8BIT, 0x011E, 0x13},
	{ IMX_8BIT, 0x011F, 0x33},
	{ IMX_8BIT, 0x0301, 0x05},
...
static struct imx_reg const imx135vb_PREVIEW_WIDE_PREVIEW_30fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	{ IMX_8BIT, 0x011E, 0x13},
	{ IMX_8BIT, 0x011F, 0x33},
	{ IMX_8BIT, 0x0301, 0x05},
...
static struct imx_reg const imx135vb_PREVIEW_1632x1224_30fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	{ IMX_8BIT, 0x011E, 0x13},
	{ IMX_8BIT, 0x011F, 0x33},
	{ IMX_8BIT, 0x0301, 0x05},
...
/* Video1: H : 216 V : 176 */
static const struct imx_reg imx135vb_QCIF_strong_dvs_30fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	/* Mode setting */
	{IMX_8BIT, 0x0108, 0x03 },
	{IMX_8BIT, 0x0112, 0x0A },
...
/* Video2: H : 408 V : 308 */
static const struct imx_reg imx135vb_QVGA_strong_dvs_30fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	/* Mode setting */
	{IMX_8BIT, 0x0108, 0x03 },
	{IMX_8BIT, 0x0112, 0x0A },
...
/* Video3: H : 820 V : 616 */
static const struct imx_reg imx135vb_VGA_strong_dvs_30fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	/* Mode setting */
	{IMX_8BIT, 0x0108, 0x03 },
	{IMX_8BIT, 0x0112, 0x0A },
...
static const struct imx_reg imx135vb_WVGA_strong_dvs_30fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	/* Mode setting */
	{IMX_8BIT, 0x0108, 0x03 },
	{IMX_8BIT, 0x0112, 0x0A },
...
/* Video5: H : 1568 V : 880 */
static const struct imx_reg imx135vb_720p_strong_dvs_30fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	/* Mode setting */
	{IMX_8BIT, 0x0108, 0x03 },
	{IMX_8BIT, 0x0112, 0x0A },
...
/* Video6: H : 2336V : 1308 */
static const struct imx_reg imx135vb_1080p_strong_dvs_30fps[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	/* Mode setting */
	{IMX_8BIT, 0x0108, 0x03 },
	{IMX_8BIT, 0x0112, 0x0A },
...
static const struct imx_reg imx135vb_2336x1320_30fps[] = {
	/* Video */
	/* H : 2336 */
	/* V : 1320 */
	/* clock setting */
...
struct imx_resolution imx135vb_res_preview[] = {
	...
	{
		.desc = "imx135vb_PREVIEW_848x616_30fps",
		.regs = imx135vb_PREVIEW_848x616_30fps,
		.width = 848,
		.height = 616,
		.fps = 30,
	...
	{
		.desc = "imx135vb_PREVIEW_WIDE_PREVIEW_30fps",
		.regs = imx135vb_PREVIEW_WIDE_PREVIEW_30fps,
		.width = 1280,
		.height = 720,
		.fps = 30,
		.pixels_per_line = 4572,
	...
	{
		.desc = "imx135vb_720p_30fps",
		.regs = imx135vb_720p_30fps,
		.width = 1296,
		.height = 736,
		.fps = 30,
		.pixels_per_line = 4572,
	...
	{
		.desc = "imx135vb_1M_16_9_30fps",
		.regs = imx135vb_1M_16_9_30fps,
		.width = 1040,
		.height = 592,
		.fps = 30,
		.pixels_per_line = 4572,
	...
	{
		.desc = "imx135vb_1M_4_3_30fps",
		.regs = imx135vb_1M_4_3_30fps,
		.width = 1640,
		.height = 1232,
		.fps = 30,
		.pixels_per_line = 4572,
	...
	{
		.desc = "imx135vb_1080p_30fps",
		.regs = imx135vb_1080p_30fps,
		.width = 1936,
		.height = 1104,
		.fps = 30,
		.pixels_per_line = 4572,
	...
	{
		.desc = "imx135vb_PREVIEW_1632x1224_30fps",
		.regs = imx135vb_PREVIEW_1632x1224_30fps,
		.width = 1632,
		.height = 1224,
		.fps = 30,
		.pixels_per_line = 4572,
	...
	{
		.desc = "imx135vb_2M_30fps",
		.regs = imx135vb_2M_30fps,
		.width = 1640,
		.height = 1232,
		.fps = 30,
	...
	{
		.desc = "imx135vb_5M_19fps",
		.regs = imx135vb_5M_STILL_19fps,
		.width = 2576,
		.height = 1936,
		.fps = 19,
		.pixels_per_line = 4572, /* consistent with regs arrays */
	...
	{
		.desc = "imx135vb_6M_STILL_20fps",
		.regs = imx135vb_6M_STILL_20fps,
		.width = 3280,
		.height = 1852,
		.fps = 20,
	...
	{
		.desc = "imx135vb_8M_15fps",
		.regs = imx135vb_8M_STILL_15fps,
		.width = 3280,
		.height = 2464,
		.fps = 15,
		.pixels_per_line = 4572, /* consistent with regs arrays */
	...
	{
		.desc = "imx135vb_13M_24fps",
		.regs = imx135vb_13M_24fps,
		.width = 4208,
		.height = 3120,
		.fps = 24,
		.pixels_per_line = 4572,
...
struct imx_resolution imx135vb_res_still[] = {
	{
		.desc = "imx135vb_QCIF_30fps",
		.regs = imx135vb_QCIF_30fps,
		.width = 192,
		.height = 160,
		.fps = 30,
		.pixels_per_line = 4572, /* consistent with regs arrays */
	...
	{
		.desc = "imx135vb_QVGA_30fps",
		.regs = imx135vb_QVGA_30fps,
		.width = 336,
		.height = 256,
		.fps = 30,
		.pixels_per_line = 4572, /* consistent with regs arrays */
	...
	{
		.desc = "imx135vb_CIF_30fps",
		.regs = imx135vb_CIF_30fps,
		.width = 368,
		.height = 304,
		.fps = 30,
		.pixels_per_line = 4572, /* consistent with regs arrays */
	...
	{
		.desc = "imx135vb_VGA_30fps",
		.regs = imx135vb_VGA_30fps,
		.width = 656,
		.height = 496,
		.fps = 30,
		.pixels_per_line = 4572, /* consistent with regs arrays */
	...
	{
		.desc = "imx135vb_D1_30fps",
		.regs = imx135vb_D1_30fps,
		.width = 736,
		.height = 496,
		.fps = 30,
		.pixels_per_line = 4572, /* consistent with regs arrays */
	...
	{
		.desc = "imx135vb_VGA_dvs_30fps",
		.regs = imx135vb_VGA_dvs_30fps,
		.width = 820,
		.height = 616,
		.fps = 30,
		.pixels_per_line = 4572,
	...
	{
		.desc = "imx135vb_1600x1200_30fps",
		.regs = imx135vb_1600x1200_30fps,
		.width = 1632,
		.height = 1224,
		.fps = 30,
		.pixels_per_line = 4572, /* consistent with regs arrays */
	...
	{
		.desc = "imx135vb_3M_30fps",
		.regs = imx135vb_3M_30fps,
		.width = 2064,
		.height = 1552,
		.fps = 30,
		.pixels_per_line = 4572, /* consistent with regs arrays */
	...
	{
		.desc = "imx135vb_8M_3fps",
		.regs = imx135vb_8M_3fps,
		.width = 3280,
		.height = 2464,
		.fps = 3,
	...
	{
		.desc = "imx135vb_13M_3fps",
		.regs = imx135vb_13M_3fps,
		.width = 4208,
		.height = 3120,
		.fps = 3,
...
struct imx_resolution imx135vb_res_video[] = {
	{
		.desc = "imx135vb_2336x1320_30fps",
		.regs = imx135vb_2336x1320_30fps,
		.width = 2336,
		.height = 1320,
		.fps = 30,
		.pixels_per_line = 4572, /* consistent with regs arrays */
		.lines_per_frame = 2608, /* consistent with regs arrays */
		.bin_factor_x = 0,
		.bin_factor_y = 0,
		.used = 0,
	},
...
struct imx_resolution imx135vb_res_video_nodvs[] = {
	{
		.desc = "imx135vb_QCIF_30fps",
		.regs = imx135vb_QCIF_30fps,
		.width = 192,
