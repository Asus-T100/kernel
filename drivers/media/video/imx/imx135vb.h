...
/* Settings for preview and still capture */
...
static struct imx_reg const imx135vb_5m_scaled_from_12m[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	PLL_SETTINGS_FOR_MIPI_448_8MHZ,
	/* Mode setting */
	{IMX_8BIT, 0x0108, 0x03},
	...
	{IMX_8BIT, 0x034C, 0x0A}, /* 2576x1936*/
...
static struct imx_reg const imx135vb_5m_scaled_from_12m_for_mipi_342[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	PLL_SETTINGS_FOR_MIPI_342MHZ,
	/* Mode setting */
	{IMX_8BIT, 0x0108, 0x03},
...
static struct imx_reg const imx135vb_848x616_binning[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	PLL_SETTINGS_FOR_MIPI_209_6MHZ,
	/* Mode setting */
	{IMX_8BIT, 0x0108, 0x03 },
...
static struct imx_reg const imx135vb_1m_16_9_binning[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	PLL_SETTINGS_FOR_MIPI_209_6MHZ,
	/*mode setting*/
	{IMX_8BIT, 0x0108, 0x03},
...
/* Preview: H : 1632 V : 1224 */
static struct imx_reg const imx135vb_1632x1224_binning[] = {
	GROUPED_PARAMETER_HOLD_ENABLE,
	PLL_SETTINGS_FOR_MIPI_209_6MHZ,
	/* Mode setting */
	{IMX_8BIT, 0x0108, 0x03 },
...
struct imx_resolution imx135vb_res_preview[] = {
	...
	{
		.desc = "imx135vb_848x616_binning_preview",
		.regs = imx135vb_848x616_binning,
		.width = 848,
		.height = 616,
		.fps = 30,
	...
	{
		.desc = "imx135vb_1m_16_9_binning_preview",
		.regs = imx135vb_1m_16_9_binning,
		.width = 1040,
		.height = 592,
		.fps = 30,
		.pixels_per_line = 5464,
	...
	{
		.desc = "imx135vb_1632x1224_binning_preview",
		.regs = imx135vb_1632x1224_binning,
		.width = 1632,
		.height = 1224,
		.fps = 30,
		.pixels_per_line = 5464,
	...
	/* For the below modes pixel clokc is 359.04 */
	{
		.desc = "imx135vb_5m_scaled_from_12m_cont_cap",
		.regs = imx135vb_5m_scaled_from_12m,
		.width = 2576,
		.height = 1936,
		.fps = 24,
	...
	{
		.desc = "imx135vb_8m_scaled_from_12m_cont_cap",
...
struct imx_resolution imx135vb_res_still[] = {
	/* For binning modes pix clock is 335.36 MHz. */
	{
		.desc = "imx135vb_848x616_binning_still",
		.regs = imx135vb_848x616_binning,
		.width = 848,
		.height = 616,
		.fps = 15,
	...
	{
		.desc = "imx135vb_1m_16_9_binning_still",
		.regs = imx135vb_1m_16_9_binning,
		.width = 1040,
		.height = 592,
		.fps = 15,
	...
	{
		.desc = "imx135vb_1632x1224_binning_still",
		.regs = imx135vb_1632x1224_binning,
		.width = 1632,
		.height = 1224,
		.fps = 15,
	...
	/* For the belo 15FPS modes, the pixel clock is 273.6MHz */
	{
		.desc = "imx135vb_5m_scaled_from_12m_for_mipi_342_still",
		.regs = imx135vb_5m_scaled_from_12m_for_mipi_342,
		.width = 2576,
		.height = 1936,
		.fps = 15,
		.pixels_per_line = 5264,
		.lines_per_frame = 3466,
		.bin_factor_x = 0,
		.bin_factor_y = 0,
		.used = 0,
	},
