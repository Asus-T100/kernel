...
sh_css_rx_enable_all_interrupts(void)
{
	hrt_data	bits = receiver_port_reg_load(RX0_ID,
		MIPI_PORT0_ID, _HRT_CSS_RECEIVER_IRQ_ENABLE_REG_IDX);
...
/*		(1U << _HRT_CSS_RECEIVER_IRQ_ERR_LINE_SYNC_BIT); */
	...
	receiver_port_reg_store(RX0_ID,
		MIPI_PORT0_ID, _HRT_CSS_RECEIVER_IRQ_ENABLE_REG_IDX, bits);
return;
}
...
return receiver_port_reg_load(RX0_ID,
	MIPI_PORT0_ID, _HRT_CSS_RECEIVER_IRQ_STATUS_REG_IDX);
}
...
#if 0 /* PAA csi2 is getting enabled when it was never configured */
