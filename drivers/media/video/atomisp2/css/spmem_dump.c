...
#define HIVE_ADDR_isp_vectors_per_input_line 0x1F9C
#define HIVE_SIZE_isp_vectors_per_input_line 4
#else
#endif
#endif
#define HIVE_MEM_sp_isp_vectors_per_input_line scalar_processor_demo_dmem
#define HIVE_ADDR_sp_isp_vectors_per_input_line 0x1F9C
#define HIVE_SIZE_sp_isp_vectors_per_input_line 4

/* function sp_tagger_propagate_frame: 3156 */

/* function longjmp: 349B */

/* function sp_dma_proxy_read: 2899 */

/* function sp_dma_proxy_is_idle: 2A10 */

/* function debug_buffer_set_ddr_addr: 94 */

/* function sp_scheduler_set_thread_priority: 2ABA */

/* function setjmp: 34A2 */

/* function decode_sw_event: 2C9 */

/* function initialize_sp_stage: 2584 */
...
#define HIVE_ADDR_sp_cb_elems_params_capture_pipe 0x3890
...
#define HIVE_ADDR_sp_dma_proxy_thread 0x2F28
#define HIVE_SIZE_sp_dma_proxy_thread 68
#else
#endif
#endif
#define HIVE_MEM_sp_sp_dma_proxy_thread scalar_processor_demo_dmem
#define HIVE_ADDR_sp_sp_dma_proxy_thread 0x2F28
#define HIVE_SIZE_sp_sp_dma_proxy_thread 68

/* function sp_scheduler_start_thread: 2AF6 */

/* function sp_thread_switch_to: 2C46 */

/* function sp_thread_suicide: 2C82 */
...
/* function sp_debug_mode_update_command: 33EF */
...
#define HIVE_ADDR_sem_for_reading_cb_frames_capture_pipe 0x38A0
...
#define HIVE_ADDR_sp_sem_for_reading_cb_frames_capture_pipe 0x38A0
#define HIVE_SIZE_sp_sem_for_reading_cb_frames_capture_pipe 20

/* function sp_event_proxy_func: 2A3E */
...
/* function __sp_dma_proxy_func_critical: 3616 */

/* function bin_spec_init_ifs: 37C */

/* function dma_proxy_channel_release: 2A1E */

#ifndef HIVE_MULTIPLE_PROGRAMS
#ifndef HIVE_MEM_num_total_threads
#define HIVE_MEM_num_total_threads scalar_processor_demo_dmem
#define HIVE_ADDR_num_total_threads 0x2F20
#define HIVE_SIZE_num_total_threads 4
#else
#endif
#endif
#define HIVE_MEM_sp_num_total_threads scalar_processor_demo_dmem
#define HIVE_ADDR_sp_num_total_threads 0x2F20
#define HIVE_SIZE_sp_num_total_threads 4
...
/* function sp_dma_proxy_wait_for_ack: 38BB */

/* function sp_scheduler_acquire_semaphore: 3AD5 */

#ifndef HIVE_MULTIPLE_PROGRAMS
#ifndef HIVE_MEM_sp_obarea_length_bq
#define HIVE_MEM_sp_obarea_length_bq scalar_processor_demo_dmem
#define HIVE_ADDR_sp_obarea_length_bq 0x2C18
#define HIVE_SIZE_sp_obarea_length_bq 4
#else
#endif
#endif
#define HIVE_MEM_sp_sp_obarea_length_bq scalar_processor_demo_dmem
#define HIVE_ADDR_sp_sp_obarea_length_bq 0x2C18
#define HIVE_SIZE_sp_sp_obarea_length_bq 4

/* function is_ddr_debug_buffer_full: 1BD */

/* function sp_uds_init: 56E */

/* function sp_dma_proxy_isp_write_addr: 2822 */

/* function sp_circular_buf_create: 2FB5 */

/* function debug_enqueue_ddr: A7 */

/* function host2sp_dequeue_buffer: 295 */

/* function is_dynamic_buffer: 310C */

/* function sp2host_enqueue_buffer: 27B */

#ifndef HIVE_MULTIPLE_PROGRAMS
#ifndef HIVE_MEM_sp_dma_crop_block_width_b
#define HIVE_MEM_sp_dma_crop_block_width_b scalar_processor_demo_dmem
#define HIVE_ADDR_sp_dma_crop_block_width_b 0x1C28
#define HIVE_SIZE_sp_dma_crop_block_width_b 4
#else
#endif
#endif
#define HIVE_MEM_sp_sp_dma_crop_block_width_b scalar_processor_demo_dmem
#define HIVE_ADDR_sp_sp_dma_crop_block_width_b 0x1C28
...
#define HIVE_ADDR_cb_elems_params_preview_pipe 0x38FC
...
/* function sp_dma_proxy_configure_init_dmem_channel: 28AF */

/* function host2sp_buffer_queue_is_empty: 355C */

/* function sp2host_event_queue_get_size: 23C */

/* function write_trunk_data_to_ddr: 25B2 */

/* function sp_dma_proxy_read_byte_addr: 2874 */

/* function sp_thread_fork: 2C9C */

/* function sp_semaphore_wait: 3B48 */
...
#define HIVE_ADDR_sem_for_reading_cb_frames_preview_pipe 0x390C
...
#define HIVE_ADDR_sp_sem_for_reading_cb_frames_preview_pipe 0x390C
...
#define HIVE_ADDR_sp_request_flash 0x2F24
#define HIVE_SIZE_sp_request_flash 4
#else
#endif
#endif
#define HIVE_MEM_sp_sp_request_flash scalar_processor_demo_dmem
#define HIVE_ADDR_sp_sp_request_flash 0x2F24
#define HIVE_SIZE_sp_sp_request_flash 4

/* function sp_debug_mode_is_dma_request_enabled: 33D6 */

/* function dma_proxy_dma_read_write_split: 296E */

/* function cnd_input_system_cfg: 241A */

/* function sp_generate_events: 3316 */

/* function sp_uds_configure: 42A */

/* function sp_dma_proxy_execute: 2888 */

/* function __modu: 34D2 */
...
#define HIVE_ADDR_sem_for_reading_cb_frames_copy_pipe 0x3920
...
#define HIVE_ADDR_sp_sem_for_reading_cb_frames_copy_pipe 0x3920
#define HIVE_SIZE_sp_sem_for_reading_cb_frames_copy_pipe 20

/* function sp_circular_buf_push_marked: 2E3A */
...
/* function sp_fiber_init: 2B98 */

/* function sp_thread_init: 2CB3 */

/* function irq_raise_set_token: 73 */
...
/* function _dma_proxy_dma_read_write: 3929 */

/* function sp_dma_proxy_configure_init_vmem_channel: 28C9 */

/* function sp_scheduler_wait_thread: 2AEA */

/* function sp_acquire_dynamic_buf: 3061 */

/* function sp_tagger_destroy: 326B */

/* function init_isp_internal_buffers: A2D */

/* function sp_thread_queue_push: 3B9E */

/* function sp_circular_buf_push: 2F6C */

/* function sp_dma_proxy_write: 284A */

/* function sp_finish_flash_process: 2BE2 */
...
#define HIVE_ADDR_sem_for_reading_cb_params_preview_pipe 0x3934
...
#define HIVE_ADDR_sp_sem_for_reading_cb_params_preview_pipe 0x3934
#define HIVE_SIZE_sp_sem_for_reading_cb_params_preview_pipe 20

/* function sp_dma_proxy_vmem_read: 280C */
...
#define HIVE_ADDR_sem_for_reading_cb_params_capture_pipe 0x3948
...
/* function sp_tagger_create: 3283 */

/* function sp_dma_proxy_vmem_write: 27F6 */

/* function sp_thread_set_priority: 2C3F */

#ifndef HIVE_MULTIPLE_PROGRAMS
#ifndef HIVE_MEM_pipe_private_dis_bufs
#define HIVE_MEM_pipe_private_dis_bufs scalar_processor_demo_dmem
#define HIVE_ADDR_pipe_private_dis_bufs 0x3588
#define HIVE_SIZE_pipe_private_dis_bufs 32
#else
#endif
#endif
#define HIVE_MEM_sp_pipe_private_dis_bufs scalar_processor_demo_dmem
#define HIVE_ADDR_sp_pipe_private_dis_bufs 0x3588
#define HIVE_SIZE_sp_pipe_private_dis_bufs 32

/* function sp_semaphore_signal: 3B24 */

/* function sp_dma_proxy_write_byte_addr: 2836 */
...
#define HIVE_ADDR_sp_isp_input_stream_format 0x2EC0
#define HIVE_SIZE_sp_isp_input_stream_format 4
#else
#endif
#endif
#define HIVE_MEM_sp_sp_isp_input_stream_format scalar_processor_demo_dmem
#define HIVE_ADDR_sp_sp_isp_input_stream_format 0x2EC0
#define HIVE_SIZE_sp_sp_isp_input_stream_format 4

/* function sp_circular_buf_push_unmarked: 2DC1 */

/* function __sp_event_proxy_func_critical: 39B5 */

/* function sp_thread_queue_pop: 3B88 */

/* function sp_circular_buf_mark: 2EAB */

/* function irq_raise: 82 */

/* function sp_circular_buf_unmark: 2E94 */

/* function _dma_proxy_dma_execute: 3969 */

/* function timed_ctrl_snd_gpio_commnd: 20B */

#ifndef HIVE_MULTIPLE_PROGRAMS
#ifndef HIVE_MEM_cb_elems_frames_preview_pipe
#define HIVE_MEM_cb_elems_frames_preview_pipe scalar_processor_demo_dmem
#define HIVE_ADDR_cb_elems_frames_preview_pipe 0x39A0
...
#define HIVE_ADDR_sp_cb_elems_frames_preview_pipe 0x39A0
...
#define HIVE_ADDR_cb_elems_frames_capture_pipe 0x39C8
...
#define HIVE_ADDR_sp_cb_elems_frames_capture_pipe 0x39C8
#define HIVE_SIZE_sp_cb_elems_frames_capture_pipe 16

/* function sp_dma_proxy_init: 2775 */

/* function sp_circular_buf_becomes_not_full: 3BB0 */

/* function sp_release_dynamic_buf: 2FCF */

/* function sp_scheduler_destroy_thread: 2B02 */

/* function timed_ctrl_snd_commnd: 22D */

/* function end_binary: 8B1 */

/* function sp2host_event_queue_is_full: 3536 */
