...
#define HIVE_ADDR_isp_vectors_per_input_line 0x2880
#define HIVE_SIZE_isp_vectors_per_input_line 4
#else
#endif
#endif
#define HIVE_MEM_sp_isp_vectors_per_input_line scalar_processor_demo_dmem
#define HIVE_ADDR_sp_isp_vectors_per_input_line 0x2880
#define HIVE_SIZE_sp_isp_vectors_per_input_line 4

/* function sp_tagger_propagate_frame: 3219 */

/* function longjmp: 351B */

/* function sp_dma_proxy_read: 2966 */

/* function sp_dma_proxy_is_idle: 2AC3 */

/* function stop_event_proxy: 2AD1 */

/* function setjmp: 3522 */

/* function decode_sw_event: 2D3 */

/* function initialize_sp_stage: 25E9 */

#ifndef HIVE_MULTIPLE_PROGRAMS
#ifndef HIVE_MEM_isp_stage
#define HIVE_MEM_isp_stage scalar_processor_demo_dmem
#define HIVE_ADDR_isp_stage 0x3730
#define HIVE_SIZE_isp_stage 516
#else
#endif
#endif
#define HIVE_MEM_sp_isp_stage scalar_processor_demo_dmem
#define HIVE_ADDR_sp_isp_stage 0x3730
...
/* function release_in_param: 30E7 */
...
#define HIVE_ADDR_cb_elems_params_capture_pipe 0x35A0
...
#define HIVE_ADDR_sp_cb_elems_params_capture_pipe 0x35A0
...
#define HIVE_ADDR_sem_for_reading_cb_frames_capture_pipe 0x35E0
...
#define HIVE_ADDR_sp_sem_for_reading_cb_frames_capture_pipe 0x35E0
#define HIVE_SIZE_sp_sem_for_reading_cb_frames_capture_pipe 24

/* function sp_event_proxy_func: 2AD8 */
...
#define HIVE_ADDR_cb_params_preview_pipe 0x35F8
#define HIVE_SIZE_cb_params_preview_pipe 20
#else
#endif
#endif
#define HIVE_MEM_sp_cb_params_preview_pipe scalar_processor_demo_dmem
#define HIVE_ADDR_sp_cb_params_preview_pipe 0x35F8
#define HIVE_SIZE_sp_cb_params_preview_pipe 20

/* function sp_semaphore_init: 3C77 */

/* function initialize_sp_group: 25CC */
...
/* function dma_proxy_channel_release: 3A95 */
...
#define HIVE_ADDR_cb_elems_params_preview_pipe 0x360C
...
#define HIVE_ADDR_sp_sems_for_sp2host_buf_queues 0x2D10
...
/* function sp_dma_proxy_configure_init_dmem_channel: 297C */

/* function sp2host_event_queue_get_size: B3 */

/* function sp_dma_proxy_read_byte_addr: 39A8 */

/* function sp_thread_fork: 2C37 */

/* function sp_semaphore_wait: 3BF2 */
...
#define HIVE_ADDR_sem_for_reading_cb_frames_preview_pipe 0x361C
...
#define HIVE_ADDR_sp_sem_for_reading_cb_frames_preview_pipe 0x361C
...
#define HIVE_ADDR_raw_frame_socket 0x3634
#define HIVE_SIZE_raw_frame_socket 20
#else
#endif
#endif
#define HIVE_MEM_sp_raw_frame_socket scalar_processor_demo_dmem
#define HIVE_ADDR_sp_raw_frame_socket 0x3634
#define HIVE_SIZE_sp_raw_frame_socket 20

/* function cnd_input_system_cfg: 249E */

/* function sp_generate_events: 3465 */

/* function sp_uds_configure: 409 */

/* function sp_dma_proxy_execute: 2955 */

/* function __modu: 3567 */

/* function sp_circular_buf_push_marked: 2D6F */
...
#define HIVE_ADDR_h_tmp_ddr_buffer_addr 0x3538
#define HIVE_SIZE_h_tmp_ddr_buffer_addr 16
#else
#endif
#endif
#define HIVE_MEM_sp_h_tmp_ddr_buffer_addr scalar_processor_demo_dmem
#define HIVE_ADDR_sp_h_tmp_ddr_buffer_addr 0x3538
#define HIVE_SIZE_sp_h_tmp_ddr_buffer_addr 16

/* function _dma_proxy_dma_read_write: 3A0E */

/* function sp_dma_proxy_configure_init_vmem_channel: 299F */

/* function sp_acquire_dynamic_buf: 300C */

#ifndef HIVE_MULTIPLE_PROGRAMS
#ifndef HIVE_MEM_isp_ph
#define HIVE_MEM_isp_ph scalar_processor_demo_dmem
#define HIVE_ADDR_isp_ph 0x21E4
#define HIVE_SIZE_isp_ph 32
#else
#endif
#endif
#define HIVE_MEM_sp_isp_ph scalar_processor_demo_dmem
#define HIVE_ADDR_sp_isp_ph 0x21E4
#define HIVE_SIZE_sp_isp_ph 32

/* function sp_tagger_destroy: 33CC */
...
#define HIVE_ADDR_target_nr_of_captured_frames 0x884
...
#define HIVE_ADDR_sp_target_nr_of_captured_frames 0x884
#define HIVE_SIZE_sp_target_nr_of_captured_frames 4

/* function sp_dma_proxy_write: 293E */
...
#define HIVE_ADDR_sem_for_reading_cb_params_preview_pipe 0x3648
...
#define HIVE_ADDR_sp_sem_for_reading_cb_params_preview_pipe 0x3648
#define HIVE_SIZE_sp_sem_for_reading_cb_params_preview_pipe 24

/* function sp_dma_proxy_vmem_read: 2913 */
...
#define HIVE_ADDR_sem_for_reading_cb_params_capture_pipe 0x3660
...
#define HIVE_ADDR_sp_sem_for_reading_cb_params_capture_pipe 0x3660
...
/* function handle_parameter_sets: 3110 */

/* function sp_tagger_create: 33E0 */

/* function sp_dma_proxy_deregister_channel_from_port: 28D0 */

#ifndef HIVE_MULTIPLE_PROGRAMS
#ifndef HIVE_MEM_pipe_private_dis_bufs
#define HIVE_MEM_pipe_private_dis_bufs scalar_processor_demo_dmem
#define HIVE_ADDR_pipe_private_dis_bufs 0x31C8
#define HIVE_SIZE_pipe_private_dis_bufs 32
#else
#endif
#endif
#define HIVE_MEM_sp_pipe_private_dis_bufs scalar_processor_demo_dmem
#define HIVE_ADDR_sp_pipe_private_dis_bufs 0x31C8
#define HIVE_SIZE_sp_pipe_private_dis_bufs 32

/* function sp_semaphore_signal: 3BBD */

/* function sp_dma_proxy_write_byte_addr: 2929 */
...
#define HIVE_ADDR_cb_elems_frames_preview_pipe 0x36B8
...
#define HIVE_ADDR_sp_cb_elems_frames_preview_pipe 0x36B8
...
#define HIVE_ADDR_cb_elems_frames_capture_pipe 0x36DC
...
/* function dma_proxy_dma_execute_split: 2A85 */
...
/* function sp_circular_buf_extract: 2E2F */
...
#define HIVE_ADDR_sems_for_host2sp_buf_queues 0x3288
...
/* function run_sp_threads: 2C7C */

/* function configure_dma_channel: 2623 */

/* function sp_dma_proxy_register_channel_to_port: 28DB */
...
#define HIVE_ADDR_isp_stop_req 0x2B40
#define HIVE_SIZE_isp_stop_req 4
#else
#endif
#endif
#define HIVE_MEM_sp_isp_stop_req scalar_processor_demo_dmem
#define HIVE_ADDR_sp_isp_stop_req 0x2B40
