...
#define MT9V113_BIT_STBY_STAT	14
#define MT9V113_MASK_STBY_STAT	(1 << MT9V113_BIT_STBY_STAT)

#define MT9V113_BIT_STBY_REQ	0
#define MT9V113_MASK_STBY_REQ	(1 << MT9V113_BIT_STBY_REQ)

#define MT9V113_BIT_PLL_STAT	15
#define MT9V113_MASK_PLL_STAT	(1 << MT9V113_BIT_PLL_STAT)

#define MT9V113_BIT_INIT_PLL	0
#define MT9V113_MASK_INIT_PLL	(1 << MT9V113_BIT_INIT_PLL)

#define MT9V113_BIT_EN_PLL	1
#define MT9V113_MASK_EN_PLL	(1 << MT9V113_BIT_EN_PLL)

#define MT9V113_BIT_EN_MIPI	9
#define MT9V113_MASK_EN_MIPI	(1 << MT9V113_BIT_EN_MIPI)

#define MT9V113_BIT_SENS_OUT	7
#define MT9V113_MASK_SENS_OUT	(1 << MT9V113_BIT_SENS_OUT)
