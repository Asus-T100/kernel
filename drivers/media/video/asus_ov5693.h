...
#define OV5693_FOCAL_LENGTH_NUM	295	/*2.95mm*/
...
//;;;;;;;;;;;  Resolution Control  ;;;;;;;;;;;;;;;;;;;;
	...
	{OV5693_8BIT, 0x3801, 0x04},  //;{3800,3801} Array X start
	{OV5693_8BIT, 0x3802, 0x00},  //;{3802,3803} Array Y start
	{OV5693_8BIT, 0x3803, 0x00},  //;{3802,3803} Array Y start

	{OV5693_8BIT, 0x3804, 0x0a},  //;{3804,3805} Array X end
	{OV5693_8BIT, 0x3805, 0x3b},  //;{3804,3805} Array X end
	{OV5693_8BIT, 0x3806, 0x07},  //;{3806,3807} Array Y end
	{OV5693_8BIT, 0x3807, 0xa3},  //;{3806,3807} Array Y end

	{OV5693_8BIT, 0x3808, 0x0a},  //;{3808,3809} Final output H size
	{OV5693_8BIT, 0x3809, 0x30},  //;20  ;{3808,3809} Final output H size
	{OV5693_8BIT, 0x380a, 0x07},  //;{380a,380b} Final output V size
	{OV5693_8BIT, 0x380b, 0xA0},  //; 98  ;{380a,380b} Final output V size

	{OV5693_8BIT, 0x380c, 0x0a},  //;{380c,380d} HTS
	{OV5693_8BIT, 0x380d, 0x84},  //;{380c,380d} HTS
	{OV5693_8BIT, 0x380e, 0x07},  //;{380e,380f} VTS
	{OV5693_8BIT, 0x380f, 0xbc},  //;{380e,380f} VTS

	{OV5693_8BIT, 0x3810, 0x00},  //;{3810,3811} windowing X offset
	{OV5693_8BIT, 0x3811, 0x04},  //;{3810,3811} windowing X offset
	{OV5693_8BIT, 0x3812, 0x00},  //;{3812,3813} windowing Y offset
	{OV5693_8BIT, 0x3813, 0x02},  //;{3812,3813} windowing Y offset
	{OV5693_TOK_TERM, 0, 0}
};

/*
 * 656x496 60fps 1lane 10bit(Binning+Skipping)
 */
static struct ov5693_reg const ov5693_656x496[] = {
	...
	{OV5693_8BIT, 0x3801, 0x00},
	{OV5693_8BIT, 0x3802, 0x00},
	{OV5693_8BIT, 0x3803, 0xf8},
	{OV5693_8BIT, 0x3804, 0x0a},
	{OV5693_8BIT, 0x3805, 0x3f},
	{OV5693_8BIT, 0x3806, 0x06},
	{OV5693_8BIT, 0x3807, 0xab},
...
/*
 * 736x496 30fps 2lane 10bit(Scaling)
 */
...
static struct ov5693_reg const ov5693_1296x736[] = {
	...
	{OV5693_8BIT, 0x3810, 0x00}, //; Movt it to Center.
...
/*
 * 1936x1096 30fps 2lane 10bit (Scaling)
 */
static struct ov5693_reg const ov5693_1936x1096[] = {
	{OV5693_8BIT, 0x0103, 0x01},
	{OV5693_8BIT, 0x3001, 0x0a},
	{OV5693_8BIT, 0x3002, 0x80},
	{OV5693_8BIT, 0x3006, 0x00},
	...
	{OV5693_8BIT, 0x3808, 0x08},
	{OV5693_8BIT, 0x3809, 0x40},
	{OV5693_8BIT, 0x380a, 0x04},
	{OV5693_8BIT, 0x380b, 0xa4},
	{OV5693_8BIT, 0x380c, 0x0a},
	{OV5693_8BIT, 0x380d, 0x80},
	{OV5693_8BIT, 0x380e, 0x07},
	{OV5693_8BIT, 0x380f, 0xc0},
	...
	{OV5693_8BIT, 0x3808, 0x07},  // {3808,3809} Final output H size
	{OV5693_8BIT, 0x3809, 0x90},  // {3808,3809} Final output H size
	{OV5693_8BIT, 0x380a, 0x04},  // {380a,380b} Final output V size
	{OV5693_8BIT, 0x380b, 0x48},  // {380a,380b} Final output V size
	{OV5693_TOK_TERM, 0, 0}
};

/*
 * 2064x1552 30fps 2lane 10Bit
 */
static struct ov5693_reg const ov5693_2064x1552_30fps[] = {
	{OV5693_8BIT, 0x0103, 0x01},
	{OV5693_8BIT, 0x3001, 0x0a},
	{OV5693_8BIT, 0x3002, 0x80},
	{OV5693_8BIT, 0x3006, 0x00},
...
//;;;;;;;;;;;  Resolution Control  ;;;;;;;;;;;;;;;;;;;;
	...
	{OV5693_8BIT, 0x3804, 0x0a},  //;{3804,3805} Array X end
	{OV5693_8BIT, 0x3805, 0x3b},  //;{3804,3805} Array X end
	{OV5693_8BIT, 0x3806, 0x06},  //;{3806,3807} Array Y end
	{OV5693_8BIT, 0x3807, 0xa3},  //;{3806,3807} Array Y end

	{OV5693_8BIT, 0x3808, 0x08},  //;{3808,3809} Final output H size
	{OV5693_8BIT, 0x3809, 0x10},  //;{3808,3809} Final output H size
	{OV5693_8BIT, 0x380a, 0x06},  //;{380a,380b} Final output V size
	{OV5693_8BIT, 0x380b, 0x10},  //;{380a,380b} Final output V size
...
/*
 * 2608x1474 30fps 2lane 10Bit
 */
static struct ov5693_reg const ov5693_2608x1474_30fps[] = {
	{OV5693_8BIT, 0x0103, 0x01},
	{OV5693_8BIT, 0x3001, 0x0a},
	{OV5693_8BIT, 0x3002, 0x80},
	{OV5693_8BIT, 0x3006, 0x00},
...
//;;;;;;;;;;;  Resolution Control  ;;;;;;;;;;;;;;;;;;;;
	...
	{OV5693_8BIT, 0x3808, 0x0a},  //;{3808,3809} Final output H size
	{OV5693_8BIT, 0x3809, 0x30},  //;{3808,3809} Final output H size
	{OV5693_8BIT, 0x380a, 0x05},  //;{380a,380b} Final output V size
	{OV5693_8BIT, 0x380b, 0xc2},  //;{380a,380b} Final output V size
...
/*
 * 2608x1952 30fps 2lane 10Bit
 */
static struct ov5693_reg const ov5693_2608x1952_30fps[] = {
	{OV5693_8BIT, 0x0103, 0x01},	// software reset
	{OV5693_8BIT, 0x3001, 0x0a},	// 
	{OV5693_8BIT, 0x3002, 0x80},
	{OV5693_8BIT, 0x3006, 0x00},
	{OV5693_8BIT, 0x3011, 0x21},
...
struct ov5693_resolution ov5693_res_preview[] = {
	{
		...
		.fps = 30,
		.used = 0,
		.pixels_per_line = 0x0a84, //HTS
		.lines_per_frame = 0x07bc, //VTS
		.bin_factor_x = 1,
		.bin_factor_y = 1,
		.bin_mode = 0,
		.regs = ov5693_2608x1952_30fps,
	},
	{
		.desc = "ov5693_4M_30fps",
		.width = 2608,
		.height = 1474,
		.pix_clk_freq = 81,
		.fps = 30,
		...
		.bin_factor_y = 1,
		.bin_mode = 0,
		.regs = ov5693_2608x1474_30fps,
	},
	{
		.desc = "ov5693_3M_30fps",
		.width = 2064,
		.height = 1552,
		.pix_clk_freq = 81,
		.fps = 30,
	...
	},
	{
		...
		.bin_factor_y = 1,
		.bin_mode = 0,
		.regs = ov5693_1936x1096,
	},
	{
		.desc = "ov5693_960p_30fps",
		.width = 1296,
		.height = 976,
		.fps = 30,
		.pix_clk_freq = 81,
