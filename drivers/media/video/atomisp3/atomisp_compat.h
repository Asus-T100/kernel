...
void ia_css_video_set_dis_envelope(struct atomisp_sub_device *isp_subdev,
			      unsigned int dvs_w,
			      unsigned int dvs_h);
void ia_css_input_set_effective_resolution(struct atomisp_sub_device
					   *isp_subdev,
			unsigned int width, unsigned int height);
void ia_css_input_set_resolution(struct atomisp_sub_device *isp_subdev,
			unsigned int width, unsigned int height);
void ia_css_input_set_binning_factor(struct atomisp_sub_device *isp_subdev,
				     int binning);
void ia_css_input_set_bayer_order(struct atomisp_sub_device *isp_subdev,
			     enum ia_css_bayer_order order);
void ia_css_input_set_format(struct atomisp_sub_device *isp_subdev,
