...
/* Driver version */
#define NTRIG_DRIVER_VERSION "4.10"
...
extern int g4_ntrig_debug_flag;
void g4_set_ntrig_debug_flag(char debug_flag);
char g4_get_ntrig_debug_flag_as_char(void);
