...
enum DMAC_eAccDel {
	...
	PSB_DMAC_ACC_DEL_256 = 0x1,
	/* Access delay 512 clock cycles */
	PSB_DMAC_ACC_DEL_512 = 0x2,
	/* Access delay 768 clock cycles */
	PSB_DMAC_ACC_DEL_768 = 0x3,
	/* Access delay 1024 clock cycles */
	PSB_DMAC_ACC_DEL_1024 = 0x4,
	/* Access delay 1280 clock cycles */
	PSB_DMAC_ACC_DEL_1280 = 0x5,
	/* Access delay 1536 clock cycles */
	PSB_DMAC_ACC_DEL_1536 = 0x6,
...
enum DMAC_eBurst {
	...
	/* burst size of 1 */
	PSB_DMAC_BURST_1 = 0x1,
	/* burst size of 2 */
	PSB_DMAC_BURST_2 = 0x2,
	/* burst size of 3 */
	PSB_DMAC_BURST_3 = 0x3,
	/* burst size of 4 */
	PSB_DMAC_BURST_4 = 0x4,
	/* burst size of 5 */
	PSB_DMAC_BURST_5 = 0x5,
	/* burst size of 6 */
	PSB_DMAC_BURST_6 = 0x6,
	/* burst size of 7 */
...
psb_host_second_pass(struct drm_device *dev,
		     ...
		     uint32_t ui32DeblockSourceY, uint32_t ui32DeblockSourceUV);
...
#define MSVDX_CORE_CR_FE_MSVDX_WDT_CONTROL_FE_WDT_CLEAR_SELECT_MASK \
							(0x00000030)
#define MSVDX_CORE_CR_FE_MSVDX_WDT_CONTROL_FE_WDT_CLEAR_SELECT_LSBMASK \
							(0x00000003)
...
#define MSVDX_CORE_CR_FE_MSVDX_WDT_CONTROL_FE_WDT_CLKDIV_SELECT_MASK \
							(0x00000007)
#define MSVDX_CORE_CR_FE_MSVDX_WDT_CONTROL_FE_WDT_CLKDIV_SELECT_LSBMASK	\
							(0x00000007)
...
#define MSVDX_CORE_CR_BE_MSVDX_WDT_CONTROL_BE_WDT_CLEAR_SELECT_MASK \
							(0x000000F0)
#define MSVDX_CORE_CR_BE_MSVDX_WDT_CONTROL_BE_WDT_CLEAR_SELECT_LSBMASK \
							(0x0000000F)
...
#define MSVDX_CORE_CR_BE_MSVDX_WDT_CONTROL_BE_WDT_CLKDIV_SELECT_MASK \
							(0x00000007)
#define MSVDX_CORE_CR_BE_MSVDX_WDT_CONTROL_BE_WDT_CLKDIV_SELECT_LSBMASK	\
							(0x00000007)
...
struct msvdx_private {
	...
	struct drm_psb_msvdx_frame_info_t frame_info[MAX_DECODE_BUFFERS];
	struct drm_psb_msvdx_decode_status_t decode_status;
...
#define FW_DXVA_OOLD_MMUPTD_TYPE                u32
