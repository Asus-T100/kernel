...
/* FIXME_XU: This file was copied and revised from dc_example.h */

#include "dc_mrfld.h"

MODULE_SUPPORTED_DEVICE(DEVNAME);

/* FIXME_XU: copied from nohw_linux/Makefile */
...
PVRSRV_ERROR MerrifieldDCInit(struct drm_device unref__ * dev)
{
