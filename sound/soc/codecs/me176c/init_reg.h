...
/*	{RT5640_I2S1_SDP	, 0xD000},//change IIS1 and IIS2*/
	/*record */
	{RT5640_IN1_IN2, 0x5000},	/*IN1 boost 40db and differential mode */
	{RT5640_IN3_IN4, 0x0800},	/*IN2 boost 40db and signal ended mode */
...
static void set_drc(struct snd_soc_codec *codec, int drc_mode)
{
	...
	switch (drc_mode) {
	case 0: /*int mic*/
		snd_soc_write(codec, RT5640_DRC_AGC_2, 0x35c8);
		snd_soc_write(codec, RT5640_DRC_AGC_3, 0xe4c8);
		snd_soc_write(codec, RT5640_DRC_AGC_1, 0xc108);
		break;
	case 1: /*headset mic*/
		snd_soc_write(codec, RT5640_DRC_AGC_2, 0x1f40);
		snd_soc_write(codec, RT5640_DRC_AGC_3, 0xa1c3);
		snd_soc_write(codec, RT5640_DRC_AGC_1, 0xc006);
		break;
	case 2: /*spk*/
		if (snd_soc_read(codec, RT5640_PWR_DIG1) & RT5640_PWR_CLS_D) {
			snd_soc_write(codec, RT5640_DRC_AGC_2, 0x1fc4);
			snd_soc_write(codec, RT5640_DRC_AGC_3, 0x0080);
			snd_soc_write(codec, RT5640_DRC_AGC_1, 0x4106);
		} else {
