...
//<asus-baron20131016->    {0x3fd2, 0x0038}, {0x229C, 0x0fa0}, {0x22d2, 0x8400}, {0x22ee, 0x0001},
	{0x229c, 0x0fa0}, {0x22d2, 0x8400}, {0x22ee, 0x0001}, //<asus-baron20131016+>
	{0x22f2, 0x0040}, {0x22f5, 0x8000}, {0x22f6, 0x0000}, {0x22f9, 0x007f},
//<asus-baron20131016->	{0x2310, 0x0812}, {0x22fb, 0x0000},  
	{0x2310, 0x0812},  //<asus-baron20131016+>
};
...
//<asus-baron20131016->	{0x22c8, 0x0026}, {0x22fe, 0x0fa0}, {0x22ff, 0x3893}, {0x22fa, 0x2487},
//<asus-baron20131016->	{0x2301, 0x0002},
	{0x22c8, 0x0026}, {0x22fe, 0x0e5b}, {0x22fa, 0x248f}, //<asus-baron20131016+>
	{0x2301, 0x0002}, {0x22c6, 0x000c}, {0x22c7, 0x000c}, {0x22f8, 0x8005}, //<asus-baron20131016+>
};
...
static const u16 rt5640_dsp_441[][2] = {
	...
	{0x22ff, 0x3c83}, {0x22fa, 0x248c}, {0x2301, 0x0001}, //<asus-baron20131016+>
};

#define RT5640_DSP_441_NUM (sizeof(rt5640_dsp_441) / sizeof(rt5640_dsp_441[0]))

static const u16 rt5640_dsp_16[][2] = {
	{0x22c8, 0x0026}, {0x22fa, 0x248c}, {0x2301, 0x0002}, //<asus-baron20131016+>
};

#define RT5640_DSP_16_NUM (sizeof(rt5640_dsp_16) / sizeof(rt5640_dsp_16[0]))

static const u16 rt5640_dsp_aec_ns_fens[][2] = {
//<asus-baron20131016->	{0x22f8, 0x8005}, {0x2303, 0x0971}, {0x2304, 0x0312}, {0x2305, 0x0005},
	{0x2303, 0x0971}, {0x2304, 0x0312}, {0x2305, 0x0005},  //<asus-baron20131016+>
	{0x2309, 0x0400}, {0x230a, 0x1b00}, {0x230c, 0x006D}, {0x230d, 0x0300}, //<asus-baron20131016+>
//<asus-baron20131016->	{0x2310, 0x0824}, {0x2325, 0x5000}, {0x2326, 0x0040}, {0x232f, 0x0080},
	{0x2325, 0x5000}, {0x2326, 0x0040}, {0x232f, 0x0080},  //<asus-baron20131016+>
	...
	{0x236e, 0x21E6}, {0x236f, 0x0a0a}, {0x2370, 0x0f00}, {0x2372, 0x1a00}, //<asus-baron20131026+> modify 0x236e from 0x1800 to 0x21E6
...
//<asus-baron20131016->	dsp_val &= ~(RT5640_DSP_R_EN | RT5640_DSP_CMD_MASK); 
//<asus-baron20131016->	dsp_val |= RT5640_DSP_W_EN | param->cmd;
	dsp_val &= ~(RT5640_DSP_R_EN | RT5640_DSP_CMD_MASK | RT5640_DSP_CLK_MASK); //<asus-baron20131016+>
	dsp_val |= RT5640_DSP_W_EN | RT5640_DSP_CLK_192K | param->cmd; //<asus-baron20131016+>
...
static int rt5640_dsp_rate(struct snd_soc_codec *codec, int rate)
{
	...
	const u16 (*rate_tab)[2];
        ...
        dev_err(codec->dev, "dsp rate: %d\n", rate);  //<asus-baron20131016+>
