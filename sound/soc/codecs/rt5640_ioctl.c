...
hweq_t hweq_param[] = {
	...
	,
	{			/* SPK */
	//<asus-baron20131007-> {0xa0, 0xa1, 0xa2, 0xa3, 0xa4, 0xa5, 0xa6, 0xa7, 0xa8, 0xa9, 0xaa,
	//<asus-baron20131007->  0xab, 0xac, 0xad, 0xae, 0xaf, 0xb0, 0xb1, 0xb2}
	//<asus-baron20131007+> 
	{0xb0, 0xb1, 0xb2}
	 ,
	 //<asus-baron20130830+>
	 ...
	 */
	 ...
	 ,
	 0x0040, //EQ Control 2 register (MX-B1h) (Enable bit 6 EQ High Pass 2nd Butterworth Filiter Control)
	 //<asus-baron20131007->
	 //<asus-baron20130830->
	 }
	,
