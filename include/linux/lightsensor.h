...
#define ASUS_LSENSOR_SETCALI_DATA _IOW(LIGHTSENSOR_IOCTL_MAGIC, 3, uint16_t)
#define ASUS_LSENSOR_GETCALI_DATA _IOR(LIGHTSENSOR_IOCTL_MAGIC, 5, uint16_t)
#define ASUS_LSENSOR_IOCTL_GETLUXDATA _IOR(LIGHTSENSOR_IOCTL_MAGIC, 4, int)
//<ASUS-Hollie 20130912->
