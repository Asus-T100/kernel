...
#define KIONIX_ACCEL_NAME			"KXTJ2100"
...
static struct kionix_accel_platform_data accel_platform_data = {
	.min_interval = 5,
	.poll_interval = 200,
	.accel_direction = 7,
...
static struct i2c_board_info kxtj2_board_info = {
	I2C_BOARD_INFO(KIONIX_ACCEL_NAME, KXTJ2_I2C_ADDRESS),
	.irq = 0,
	.platform_data = &accel_platform_data,
};
